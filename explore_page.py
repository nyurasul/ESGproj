...
def show_explore_page():
    ...
    st.caption(
    """
    ##### Данные по 16 крупнейшим российским компаниям за 3 года (2019–2021 гг.) использовались в работе. ESG-оценки были собраны с RAEX-Europe. Информация о выручке компаний взята с интернет-ресурса «smart-lab.ru», который представляет крупное в России сообщество инвесторов и трейдеров.
    """
    )
